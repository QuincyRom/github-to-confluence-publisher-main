...
def createPage(title, content, parentPageID, login, password):
    ...
    newPagejsonQuery['body']['storage']['value'] = "<p style=\"background-color:#e7be17;\">This page is auto generated. Make changes in the GitHub repository: " + \
                                                    "<b><a href=\"https://github.com/QuincyRom/github-to-confluence-publisher-main\">G-Star</a></b></p>" + content
