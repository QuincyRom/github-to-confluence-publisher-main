...
def createPage(title, content, parentPageID, login, password):
    ...
    newPagejsonQuery['body']['storage']['value'] = "<b>This page is auto generated by the inQdo GitHub Converter. To edit, please make changes in the GitHub repository: </b>" + \
                                                  "<b><a href=\"https://github.com/QuincyRom/github-to-confluence-publisher-main\">G-Star</a></b>" + content
